...
define config.name = _("renpy_amadeus")
...
define build.name = "renpy_amadeus"
...
define config.save_directory = "renpy_amadeus-1735820741"
...
init python:
    ...
    build.classify('game/python-packages/RenPyUtil/Demo/**', None)
